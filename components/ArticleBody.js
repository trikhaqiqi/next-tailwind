...
export default function ArticleBody() {
    return (
        <div className="prose max-w-none prose-img:rounded-2xl prose-code:text-rose-500 prose-pink prose-a:no-underline prose-blockquote:bg-gray-50 prose-blockquote:py-1 prose-headings:text-black">
